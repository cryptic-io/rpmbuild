...
#
#The above was added by the Fedora maintainers. Unfortunately python2 uses
#expat-2.0, so having both on a single system with expat support might not be
#possible. If you run into the above linker error, you need to upgrade expat.
